...
for ieta in range(22) :
    ...
    mcTable.SetFillStyle(3013)
    mcTable.SetFillColorAlpha(ROOT.kOrange-3, 0.8)
    for pumbin in range(18) :
        #mcTable.SetBinContent(pumbin, regionSubtraction_PU40_MC13TeV[18*ieta+pumbin])
        mcTable.SetBinContent(pumbin, regionSubtraction_PU40_rankInts[18*ieta+pumbin])
        mcTable.SetBinError(pumbin, 0.5)
